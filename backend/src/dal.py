# Data access layer is responsible for handling all interactions btwn apllication and DB.
# It abstracts the complexities of DB operations from the rest of the apllication.
